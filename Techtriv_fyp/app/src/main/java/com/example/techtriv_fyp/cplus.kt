...
import com.example.techtriv_fyp.databinding.ActivityCplusBinding
...
class cplus : AppCompatActivity(){
    ...
    val binding by lazy {
        ActivityCplusBinding.inflate(layoutInflater)
    }
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.trainingbegll.setOnClickListener(){
            val intent = Intent(this, cplustrainingbeg::class.java)
            startActivity(intent)
        }
        binding.traininginterll.setOnClickListener(){
            val intent = Intent(this, cplustrainingint::class.java)
            startActivity(intent)
        }
        binding.trainingadvll.setOnClickListener(){
            val intent = Intent(this, cplustrainingadv::class.java)
            startActivity(intent)
        }
    }
